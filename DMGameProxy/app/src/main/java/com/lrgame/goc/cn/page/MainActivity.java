...
//        }
    ...
    private void showBaseIdea() {
        ...
        // c>.阻力：苹果乔布斯认为Android抄袭iOS、基于Linux内核开发的Android被Linux从Linux内核主线中除名、甲骨文起诉Android侵犯java知识产权
        // d>.优势：google开源Android源代码（任何单位和个人都可以免费的获取Android源代码，并自由使用和定制）
        // e>.特点：应用框架和组件可以重复使用、允许Java语言开发和管理代码、丰富的开发环境：模拟器、调试工具、运行内存检测...、源代码完全开放
